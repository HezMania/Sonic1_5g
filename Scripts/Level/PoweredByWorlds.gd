...
# next scene
@export var nextScene = preload("res://Scene/Presentation/LevelSelect.tscn")
...
func _ready():
	...
	# This skips the intro right away and goes to whatever you need. DEBUG	
	#Global.main.change_scene_to_file(nextScene,"","",1)
