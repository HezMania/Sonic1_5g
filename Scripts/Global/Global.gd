...
var themes = [preload("res://Audio/Soundtrack/Invincibility.ogg"),preload("res://Audio/Soundtrack/Invincibility.ogg"),preload("res://Audio/Soundtrack/13 Stage Clear.ogg")]
